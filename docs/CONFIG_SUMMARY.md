...
| 工具 | 配置 |
|------|------|
| Tavily API Key | `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` |
...
| 日期 | 决策 |
|------|------|
| 2026-03-01 | 确定搜索策略：Tavily 为第一选择，web_search 为备选 |
| 2026-03-09 | 实现每周对话总结功能 |
...
| 渠道 | 状态 | AppID |
|------|------|-------|
| 飞书 (feishu) | ✅ 启用 | `cli_a9f76692d6b8dcca` |
